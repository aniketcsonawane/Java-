 ...
 * @author HP
 */
public class AdminOprationFrame extends javax.swing.JFrame {

    /**
     * Creates new form OprationFrame
     */
    public AdminOprationFrame() {
        super("Admin Oparation Frame");
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminOprationFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminOprationFrame().setVisible(true);
            }
        });
    }
