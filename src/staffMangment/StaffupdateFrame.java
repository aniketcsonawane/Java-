 ...
 * @author HP
 */
public class StaffupdateFrame extends javax.swing.JFrame {
public static boolean gen;
    /**
     * Creates new form AddStaff
     */
    public StaffupdateFrame() {
        super("Update Staff by Admin ");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(570, 90, 440, 510);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 204));
        jLabel6.setText("Update Staff Details");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(610, 20, 370, 60);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
          StaffDatafetcher df = new StaffDatafetcher();
            String user=jTextField5.getText();
        ArrayList Dt = df.fetchdata(user);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffupdateFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffupdateFrame().setVisible(true);
            }
        });
    }
