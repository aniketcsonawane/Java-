...
public static boolean gen;
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(610, 140, 430, 530);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(51, 51, 255));
        jLabel6.setText("Add Staff");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(720, 30, 180, 70);
        getContentPane().add(jLabel8);
        jLabel8.setBounds(350, -50, 380, 370);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        }else if (!chkpass(pass,cpass))
        {
            ...
            AddSaffClass as=new AddSaffClass();
            boolean flag=as.insertData(name, abr, gn, mob, mail, user, pass, cpass);
